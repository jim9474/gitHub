...
// - 실행컨텍스트란 코드실행을 위해 필요한 평가 단계와 실행단계에
//   사용되는 데이터와 환경, 실행흐름을 합친 용어
// - 4가지 코드 : 전역, 함수, eval, 모듈
// - JS는 소스코드를 실행컨텍스트에 따라 평가단계와 실행단계로 구분해
//   사용한다.
...
// 2. 지역변수 사용
//    num2의 값을 increse2만 변경할 수 있지만 증거가 되지 않는다.
...
// 4. 클로져를 IIFE(즉시실행) 형식의 생성자함수로 표현

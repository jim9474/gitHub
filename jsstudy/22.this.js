...
//   즉, 현재 사용되고 있는 메모리 또는 실행흐름이라도 이해하자.
// - JS에서는 동일한 함수내의 this라고 해도 누가 호출했느냐에 따라
//   this가 달라진다.
// - 동작바인딩(Dynamic Binding):this에 객체의 참조가 동적으로
...
function Person(name, age)  // { 부터는 생성자함수의 실행컨텍스트
 ...
 obj1.printName();
 obj1.printNumbers.call(obj2, 3, 4);    // 인자리스트 ,로 구분
 obj1.printNumbers.apply(obj2, [3, 4]); // 인자리스트 배열로 구분
 ...
 obj3.printNumbers.call(obj4, 3, 4);    // 3 4
 obj3.printNumbers.apply(obj4, [3, 4]); // 3 4
